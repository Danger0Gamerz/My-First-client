...
public final class KeyUtils {
    ...
    public static boolean isKeyPressed(int keyCode) {
        if (keyCode <= 8) {
            return GLFW.glfwGetMouseButton((long)Argon.mc.method_22683().method_4490(), (int)keyCode) == 1;
        }
        return GLFW.glfwGetKey((long)Argon.mc.method_22683().method_4490(), (int)keyCode) == 1;
    }
}
