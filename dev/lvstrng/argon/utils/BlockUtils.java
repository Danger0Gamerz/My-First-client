...
public final class BlockUtils {
    ...
    public static void rotateToBlock(class_2338 pos) {
        ...
        Rotation rotation = RotationUtils.getDirection((class_1297)Argon.mc.field_1724, pos.method_46558());
    ...
    public static boolean isAnchorCharged(class_2338 pos) {
        if (BlockUtils.isBlock(pos, class_2246.field_23152)) {
            return (Integer)Argon.mc.field_1687.method_8320(pos).method_11654((class_2769)class_4969.field_23153) != 0;
        }
        return false;
    }
    ...
    public static boolean canPlaceBlockClient(class_2338 block) {
        ...
        List list = Argon.mc.field_1687.method_8335(null, new class_238(x, y, z, x + 1.0, y + 1.0, z + 1.0));
